...
exposure_files<-exposure_files[c(4,8,9,10,11,12)]

outcome_files<- list.files(path="/dir/data/ukb/clean_cd/gwas/", 
pattern="*.txt$", full.names=TRUE, recursive=FALSE)

#Create functions to allow instrument extraction with relaxed threshold 
#If less than 5 genome-wide significant available
...
setwd("/dir/proteomewide/data/reverse_mr")
...
setwd("/dir/proteomewide/results/reverse_mr")
